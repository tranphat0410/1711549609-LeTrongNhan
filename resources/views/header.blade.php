<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 1051/24a Hậu Giang, Phường 11, Quận 6</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0933 114 738</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="/" id="logo"><img src="source/assets/dest/images/cafe.jpg" width="200px"  alt=""></a>
				</div>
