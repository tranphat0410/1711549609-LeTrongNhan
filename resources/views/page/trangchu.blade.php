...
{{--						<div class="space50">&nbsp;</div>--}}
						...
						<div class="beta-products-list">
							<h4>Cà phê Trung Nguyên</h4>
							<div class="beta-products-details">
								<p class="pull-left">Tìm thấy {{count($banh_crepe)}} sản phẩm</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
							@foreach($banh_crepe as $items)
								<div class="col-sm-3" style="margin-bottom: 10px;">
									<div class="single-item">
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$items->id)}}"><img src="source/image/product/{{$items->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$items->name}}</p>
											<p class="single-item-price"  style="font-size: 18px">
												<span class="flash-del">{{number_format($items->unit_price)}} đồng</span>
												<span class="flash-sale">{{number_format($items->promotion_price)}} đồng</span>
											</p>
										</div>
										<div class="single-item-caption" style="margin-top: 5px;">
											<a class="add-to-cart pull-left" href="{{route('themgiohang',$items->id)}}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="{{route('chitietsanpham',$items->id)}}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
